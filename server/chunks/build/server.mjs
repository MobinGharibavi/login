import { hasInjectionContext, inject, version, unref, defineAsyncComponent, defineComponent, h, getCurrentInstance, onUnmounted, toRef, isRef, ref, provide, createElementBlock, computed, shallowReactive, watch, Suspense, nextTick, Transition, Fragment, mergeProps, createApp, effectScope, reactive, shallowRef, useSSRContext, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, Text, isShallow, isReactive, toRaw, withCtx } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, l as defu, m as sanitizeStatusCode, n as createHooks, h as createError$1, t as toRouteMatcher, o as createRouter$1, p as klona, q as parse$1, r as getRequestHeader, v as getRequestHeaders, w as destr, x as isEqual$1, y as setCookie, z as getCookie, A as deleteCookie } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./filter-BeCQUo9w.mjs').then((m) => m.default || m)
  },
  {
    name: "filter___fa",
    path: "/fa/filter",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CcA0Cy97.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fa",
    path: "/fa",
...
const LazyIcon = defineAsyncComponent(() => import('./Icon--TZmBuOU.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CNTArTAf.mjs').then((r) => r.default));
...
const localeLoaders = {
  "en": [{ key: "../lang/en-US.json", load: () => import(
    './en-US-r3_5T_P-.mjs'
    /* webpackChunkName: "locale_D_58_D_58_crs_login_lang_en_US_json" */
  ), cache: true }],
  "fa": [{ key: "../lang/fa-FA.json", load: () => import(
    './fa-FA-CeIOfm1K.mjs'
    /* webpackChunkName: "locale_D_58_D_58_crs_login_lang_fa_FA_json" */
  ), cache: true }],
  "ar": [{ key: "../lang/ar-AR.json", load: () => import(
    './ar-AR-r3_5T_P-.mjs'
    /* webpackChunkName: "locale_D_58_D_58_crs_login_lang_ar_AR_json" */
  ), cache: true }]
};
...
const ClickOutside = {
  mounted(el, binding) {
    ...
    (void 0).body.addEventListener("click", el.__ClickOutside__);
  },
  unmounted(el) {
    (void 0).body.removeEventListener("click", el.__ClickOutside__);
  }
};
const outside_click_gSkWRKPnA1 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./default-BHWIDVK2.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ct9y79kH.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DgSNpNG-.mjs').then((r) => r.default || r));
...
export { __nuxt_component_2 as _, useI18n as a, useRoute as b, parseURL as c, parseQuery as d, entry$1 as default, useRuntimeConfig as e, navigateTo as f, withoutTrailingSlash as g, hasProtocol as h, injectHead as i, joinURL as j, useState as k, useNuxtApp as l, defineAppConfig as m, nuxtLinkDefaults as n, publicAssetsURL as p, resolveUnrefHeadInput as r, useRouter as u, withTrailingSlash as w };
